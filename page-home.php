        ...
        <div class="content-width">
            ...
            <div class="subscription-options">
                <div class="subscription-option core" data-product-id="846">
                    ...
                    <a href="http://consent-denied.co.uk/checkout/?add-to-cart=846" class="subscribe-button" id="core-subscribe-button" disabled>Subscribe</a>
                </div>
                ...
                <div class="subscription-option enhanced" data-product-id="847">
                    ...
                    <a href="/product/enhanced-subscription" class="action-button" id="enhanced-subscribe-button" disabled>Subscribe</a>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Subscribe buttons status:');
    subscribeButtons.forEach(button => {
        console.log(`${button.id}: ${button.disabled ? 'disabled' : 'enabled'}`);
    });
    ...
    // New debugging code for subscription buttons
    const subscriptionOptions = document.querySelectorAll('.subscription-option');
    subscriptionOptions.forEach(option => {
        option.addEventListener('click', function(e) {
            if (this.querySelector('.subscribe-button').disabled) {
                e.preventDefault();
